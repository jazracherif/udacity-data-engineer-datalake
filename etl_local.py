...
def process_song_data(spark, input_data, output_data):
    ...
    song_output_data = "./out/songs"
    songs_table.write.parquet(song_output_data, 
                              mode='overwrite',
    ...
    artist_output_data = "./out/artists"
             

    # # write artists table to parquet files
    artists_table.write.parquet(artist_output_data, 
                              mode='overwrite',
                            )
...
def process_log_data(spark, input_data, output_data):
    ...
    users_table.write.parquet('./out/users', 
                              mode='overwrite',
                            )
    ...
    # print(df_timestamp.limit(5).collect())
    ...
    print("time_table", time_table.limit(5).collect())

    # write time table to parquet files partitioned by year and month
    time_table.write.parquet('./out/times', 
                              mode='overwrite',
    ...
    print("song_df", song_df.limit(5).collect())
    ...
    songplays_table.write.parquet('./out/songplays', 
                              mode='overwrite',
                              partitionBy=["year", "month"]
                            )
